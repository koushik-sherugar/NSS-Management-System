...
const Footer = () => {
    return (
        <div><footer className="footer-1 bg-gray-100 py-2 sm:py-2">
            <div className="container mx-auto px-4">
                {/* <div className="sm:flex sm:flex-wrap sm:-mx-4 md:py-4"> */}
                {/* <div className="px-4 sm:w-1/3 md:w-1/4 xl:w-1/4">
                    ...
                    <div className="px-4 sm:w-1/3 md:w-1/4 xl:w-1/4 mt-8 sm:mt-0">
                    ...
                    <div className="px-4 sm:w-1/3 md:w-1/4 xl:w-1/4 mt-8 md:mt-0">
                ...
                <div className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8">
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="#" target="_blank" className="hover:underline">Team BOOM -MK™</a>. All Rights Reserved.
                        </span>
