...
const ViewStudent = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:5000/api/getstudenr/${student_id}`)
      .then((resp) => {
                ...
                <div className="px-6">
                  ...
                  <div className="text-center mt-12">
                    ...
                    <div className="mb-2 text-blueGray-600">
                      <i className="fas fa-student mr-2 text-lg text-blueGray-400"></i>
                    ...
                    <div className="flex flex-wrap justify-center">
                      <div className="w-full lg:w-9/12 px-4">
                        <p className="mb-4 text-lg leading-relaxed text-blueGray-700">
                          student has the power to add, delete and update the
