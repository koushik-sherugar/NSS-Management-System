                    ...
                    <div class="grid gap-5 md:grid-cols-2 md:gap-10 lg:gap-20">
                        ...
                        <div class="flex items-center">
                            <div class="mx-auto md:mx-0">
                                ...
                                <p class="mt-2 max-w-[20rem] text-lg text-white/80">Join our weekly digest. You'll also receive latest news from us.</p>
            ...
            <div className="bg-gray-50">
                <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
                    <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                        ...
                        <span className="block text-indigo-800">Be the member of NSS today.</span>
                    </h2>
