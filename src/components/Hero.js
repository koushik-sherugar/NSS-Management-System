...
const Hero = () => {
    return (
        <div name='home' className='w-screen h-screen flex flex-col justify-between overflow-hidden'>
            <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
                <div className='flex flex-col justify-center md:items-start w-full px-2 py-8'>
                    <p className='text-2xl'>Lorem ipsum dolor sit amet, consectetur adip.</p>
                    <h1 className='py-3 text-5xl md:text-7xl font-bold'>Nss Management System</h1>
                ...
                {/* <div className='absolute mt-5 flex flex-col py-8 md:min-w-[760px] bottom-[5%]
