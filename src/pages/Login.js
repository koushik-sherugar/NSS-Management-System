            ...
            <div className="md:col-span-1">
              <div className="px-4 sm:px-0">
                ...
                <p className="mt-1 text-sm text-gray-600">
                  Enter your pursonal details here.
                </p>
              </div>
            </div>
                    ...
                    <div className="grid grid-cols-6 gap-6">
                      <div className="col-span-6 sm:col-span-3">
                        ...
                        <input
                          ...
                          className="mt-1 focus:ring-indigo-500/50 focus:border-indigo-500/50 block w-full shadow-sm sm:text-md border border-gray-300 rounded-md "
                        />
                      </div>
                      ...
                      <div className="col-span-6 sm:col-span-3">
                        ...
                        <input
                          ...
                          className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-md border border-gray-300 rounded-md"
                        />
                      </div>
                    </div>
