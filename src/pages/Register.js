                        ...
                        <div className="md:grid md:grid-cols-3 md:gap-6">
                                    ...
                                    <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                                        ...
                                        <div className="grid grid-cols-6 gap-6">
                                            ...
                                            <div className="col-span-6 sm:col-span-6 lg:col-span-2">
                                                <label htmlFor="parent-name" className="after:content-['*'] after:ml-0.5 after:text-red-500 block text-sm font-medium text-gray-700">
                                            ...
                                            <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                                                <label htmlFor="aadhar-no" className="after:content-['*'] after:ml-0.5 after:text-red-500 block text-sm font-medium text-gray-700">
                                                    Aadhar Number
                                                </label>
                                                <input
                                                    required
                          ...
                          focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm lg:text-lg sm:text-md border border-gray-300 rounded-md"
                           ...
                           focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm  sm:text-sm border border-gray-300 rounded-md"
                                        ...
                                        <div className="grid grid-cols-6 gap-6">
                                            <div className="col-span-6 sm:col-span-6 lg:col-span-2">
                                                <label htmlFor="blood-group" className="after:content-['*'] after:ml-0.5 after:text-red-500 block text-sm font-medium text-gray-700">
                                            ...
                                            <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                                                <label htmlFor="mob-no" className="after:content-['*'] after:ml-0.5 after:text-red-500 block text-sm font-medium text-gray-700">
                                                    Mobile no
                                                </label>
                                                <input
                                                    type="number"
                          ...
                          focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm lg:text-lg sm:text-md border border-gray-300 rounded-md"
                                            ...
                                            <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                                                <label htmlFor="email-id" className="after:content-['*'] after:ml-0.5 after:text-red-500 block text-sm font-medium text-gray-700">
                                                    Email
                                                </label>
                          ...
                          focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm lg:text-lg sm:text-md border border-gray-300 rounded-md"
                                        ...
                                        <div className="grid grid-cols-6 gap-6">
                                            <div className="col-span-6">
                                                <label htmlFor="street-address" className="after:content-['*'] after:ml-0.5 after:text-red-500  block text-sm font-medium text-gray-700">
                                                    Street address
                                                </label>
                                                <div className="mt-1">
                                                    <textarea
                           ...
                           focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm lg:text-lg sm:text-md border border-gray-300 rounded-md"
                                            ...
                                            <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                                                <label htmlFor="postal-code" className="after:content-['*'] after:ml-0.5 after:text-red-500  block text-sm font-medium text-gray-700">
                                                    ZIP / Postal code
                                                </label>
                                ...
                                <div className="shadow overflow-hidden sm:rounded-md">
                                    <div className="px-4 py-5 bg-white sm:p-6">
                                        <div className="grid grid-cols-6 gap-6">
                                            ...
                                            <div className="col-span-6 sm:col-span-3">
                                                <label htmlFor="uni-name" className="after:content-['*'] after:ml-0.5 after:text-red-500  block text-sm font-medium text-gray-700">
                                            ...
                                            <div className="col-span-6 sm:col-span-3">
                                                <label htmlFor="college-name" className="after:content-['*'] after:ml-0.5 after:text-red-500  block text-sm font-medium text-gray-700">
                                                    college name
                                                </label>
                                                <input
                                                    type="text"
                                            ...
                                            <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                                                <label htmlFor="register-no" className="after:content-['*'] after:ml-0.5 after:text-red-500 block text-sm font-medium text-gray-700">
                                                    Register Number
                                                </label>
                                                <input
                                                    required
